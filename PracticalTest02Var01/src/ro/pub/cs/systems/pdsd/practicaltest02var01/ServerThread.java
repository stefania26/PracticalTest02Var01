...
public class ServerThread extends Thread {
	...
	private ArrayList<WeatherForecastInformation> data = null;
	...
	public ServerThread(int port) {
		...
		this.data = new ArrayList<WeatherForecastInformation>();
	}
	...
	public synchronized void setData(WeatherForecastInformation weatherForecastInformation) {
		this.data.add(weatherForecastInformation);
	}
	
	public synchronized ArrayList< WeatherForecastInformation> getData() {
		return data;
	}
